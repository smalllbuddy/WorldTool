...
You may follow this tool for a brief rundown of server world fixing, but do note that this tool has many options for all sorts of player data organization needs.
